...
class _LoginPageState extends State<LoginPage>
  ...
  void _login() async {
    ...
    try {
      final List users = await ApiService.getUsers();
      if (!mounted) return;
      ...
      _snack("Impossible de joindre l'API — vérifie que le serveur tourne",
          error: true);
    } finally {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("WELCOME BACK",
                          style: AppStyles.heading.copyWith(fontSize: 26),
                          textAlign: TextAlign.center)
                      .animate()
                      .fadeIn()
                      .slideY(begin: 0.2),
                  const SizedBox(height: 8),
                  Text("Retrouve ta communauté gamer",
                  ...
                  _field(
                      "Pseudo", _pseudoController, Icons.person_outline_rounded,
                      index: 0),
                  const SizedBox(height: 14),
                  _field("Mot de passe", _mdpController,
                  ...
                  Row(children: [
                    ...
                    Padding(
                        ...
                        child: Text("ou", style: AppStyles.subHeading)),
                    Expanded(
                        child: Divider(color: Colors.white.withOpacity(0.1))),
                  ]),
